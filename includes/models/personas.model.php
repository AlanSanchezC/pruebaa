...
class Personas {
	...
	public static function getInfoUpdate($id) {
		$sql = "SELECT id, nombre, direccion from info where id = " . $id;
	...
	public function insert() {
		...
		// Build database query
		$sql = "insert into info (nombre, direccion) values (?, ?)";
	...
	public function update() {
		...
		// Build database query
		$sql = "update info set nombre = ?, direccion = ? where id = ?";
